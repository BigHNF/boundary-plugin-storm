...
LASTERROR value is received as nil or the error/exceptions string. We use the value 1 if lasterror is not nil and the field errorLapsedSecs is lessthan poll interval. Else the value is 0. This can be used in creating alerts for the error occured.
